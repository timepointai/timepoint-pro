...
MODEL_REGISTRY: dict[str, ModelProfile] = {
    ...
    # =========================================================================
    # NVIDIA NEMOTRON FAMILY - Llama-based fine-tunes by NVIDIA
    # Available on OpenRouter with nvidia/ prefix
    # Nemotron models inherit Llama license restrictions
    # =========================================================================
    "nvidia/llama-3.1-nemotron-70b-instruct": ModelProfile(
        model_id="nvidia/llama-3.1-nemotron-70b-instruct",
        display_name="Nemotron 70B (Llama 3.1)",
        provider="nvidia",
        license="llama3.1",
        capabilities={
            ModelCapability.STRUCTURED_JSON,
        ...
        relative_cost=1.0,
        relative_quality=1.1,
        training_data_unrestricted=False,  # Llama license
        notes="NVIDIA fine-tune of Llama 3.1 70B, strong reasoning and instruction following",
    ),
    "nvidia/llama-3.3-nemotron-super-49b-v1.5": ModelProfile(
        ...
        relative_quality=1.05,
        training_data_unrestricted=False,  # Llama license
        notes="NVIDIA optimized 49B model, good balance of speed and quality",
    ),
    "nvidia/nemotron-3-nano-30b-a3b": ModelProfile(
        ...
        relative_cost=0.3,
        relative_quality=0.7,
        notes="Small efficient Nemotron, good for fast validation tasks",
    ),
    "nvidia/nemotron-3-super-120b-a12b:free": ModelProfile(
        ...
        notes="Free tier Nemotron 120B MoE, strong general-purpose",
    ),
    "nvidia/nemotron-nano-12b-v2-vl": ModelProfile(
        ...
        relative_cost=0.25,
        relative_quality=0.65,
        notes="Small vision-language Nemotron, fast for simple tasks",
    ),
    "nvidia/nemotron-nano-9b-v2": ModelProfile(
        ...
        relative_cost=0.2,
        relative_quality=0.6,
        notes="Smallest Nemotron, very fast validation and simple tasks",
    ),
    # =========================================================================
    # NOUSRESEARCH HERMES FAMILY - Fine-tuned open models
    # Strong instruction following and structured output
    # =========================================================================
    "nousresearch/hermes-2-pro-llama-3-8b": ModelProfile(
        ...
        relative_quality=0.7,
        training_data_unrestricted=False,  # Llama license
        notes="NousResearch fine-tune of Llama 3 8B, strong function calling",
    ),
    "nousresearch/hermes-3-llama-3.1-405b": ModelProfile(
        ...
        relative_speed=0.5,
        relative_cost=3.0,
        relative_quality=1.35,
        training_data_unrestricted=False,  # Llama license
        notes="Hermes fine-tune of Llama 405B, top-tier reasoning and instruction following",
    ),
    "nousresearch/hermes-3-llama-3.1-405b:free": ModelProfile(
        ...
        relative_quality=1.35,
        training_data_unrestricted=False,  # Llama license
        notes="Free tier Hermes 3 405B, same quality with rate limits",
    ),
    "nousresearch/hermes-3-llama-3.1-70b": ModelProfile(
        ...
        relative_quality=1.05,
        training_data_unrestricted=False,  # Llama license
        notes="Hermes fine-tune of Llama 70B, strong general-purpose with better instruction following",
    ),
    "nousresearch/hermes-4-405b": ModelProfile(
        ...
        relative_speed=0.5,
        relative_cost=3.0,
        relative_quality=1.4,
        training_data_unrestricted=False,  # Llama license
        notes="Latest Hermes 4 405B, best-in-class reasoning and structured output",
    ),
    "nousresearch/hermes-4-70b": ModelProfile(
        ...
        relative_quality=1.1,
        training_data_unrestricted=False,  # Llama license
        notes="Hermes 4 70B, excellent balance of quality and cost",
    ),
    # =========================================================================
