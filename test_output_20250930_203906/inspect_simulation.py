...
def inspect_entity_knowledge(entity, entity_id, output_dir):
...
def dump_all_knowledge(sim, output_file):
    ...
    for entity_id, entity in sim.entities.items():
        all_knowledge[entity_id] = inspect_entity_knowledge(entity, entity_id, output_dir)
...
def capture_entity_state(sim, timepoint_id):
