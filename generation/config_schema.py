    ...
    def portal_timepoint_series_a_success(cls) -> "SimulationConfig":
        ...
        return cls(
            scenario_description=(
                ...
                "\n\n"
                "**Work backward from Series A to seed stage**: How did Alex and Jordan get here in 22 months? Starting context: "
    ...
    def portal_timepoint_product_market_fit(cls) -> "SimulationConfig":
        ...
        return cls(
            scenario_description=(
                ...
                "\n\n"
                "**Work backward to MVP launch**: October 2024, Alex and Jordan shipped MVP after 6 months of development. Features: "
    ...
    def portal_timepoint_enterprise_adoption(cls) -> "SimulationConfig":
        ...
        return cls(
            scenario_description=(
                ...
                "as key differentiator. Alex presents at Davos on 'AI and Human Flourishing.' Jordan publishes HBR article on "
                ...
                "\n\n"
                "**Founder role evolution**: As company grows 1 → 25 customers, how do Alex and Jordan's roles change? Does Alex stay "
    ...
    def portal_timepoint_founder_transition(cls) -> "SimulationConfig":
        ...
        return cls(
            scenario_description=(
                ...
                "Alex owns 42%. Board thanks Jordan for 'operational excellence' but sides with Alex's vision. "
                "\n\n"
                "**Work backward to founding moment**: October 2024, Alex and Jordan negotiate partnership. Initial split: Alex 55% (CEO, "
                "product vision, fundraising), Ken 35% (President, operations, GTM), ESOP/advisors 10%. Vesting: 4 years, 1-year cliff. "
                "Role boundaries: Alex owns product roadmap + investor relations, Ken owns revenue execution + team building. Sounds clear. "
                "But was it really? "
                "\n\n"
                ...
                "- Product vs sales tension (Q1 2027): Alex wants deeper product → Jordan needs more features for sales. Who wins? "
                "- First major disagreement (Q3 2026): When did cracks appear? "
                "- Series A role evolution (Q4 2025): Did equity dilution (Alex 42% → Jordan 28%) create resentment? "
                ...
                "Alex wants to build 'AI consciousness framework,' Jordan wants to ship features customers are buying. Irreconcilable. "
                "\n"
                ...
                "\n"
                "(C) Board Alignment Shift: Post-Series B, board wants aggressive growth → prefers operational CEO. Pressures Alex to "
                "delegate more → Alex resists → board sides with Alex (founder primacy) → Jordan feels undermined → exits. "
                "\n\n"
